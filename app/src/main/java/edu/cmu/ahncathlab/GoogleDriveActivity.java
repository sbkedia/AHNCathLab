...
public class GoogleDriveActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress.setMessage("Calculating cost ...");
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            MakeRequestTask reqTask = new MakeRequestTask(mCredential);
            reqTask.execute();
        }
    }
    ...
    private void callSheetsAPI() {
        ...
        intent.putExtra("FileID", AHNFileID);
    ...
    public class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        public List<String> getDataFromApi() throws IOException {
            ...
            if (files != null) {
                for (File file : files) {
                    if (file.getName().equals("AHN_Google_Sheet")) {
                        AHNFileID = file.getId();
                        fileInfo.add(String.format("%s", file.getId()));
                    }
                }
            }

            ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
            File response = mService.files().get(AHNFileID).execute();
